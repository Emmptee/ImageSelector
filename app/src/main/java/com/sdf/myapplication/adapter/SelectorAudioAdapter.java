...
public class SelectorAudioAdapter extends
        RecyclerView.Adapter<SelectorAudioAdapter.ViewHolder> {
    ...
    private boolean isShowTitleForAudio = true;
    /**
     * 点击添加图片跳转
     */
    ...
    public SelectorAudioAdapter(Context context, onAddClickListener mOnAddClickListener) {
...
//            viewHolder.mImg.setVisibility(View.GONE);
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index== 0){
                        isShowTitleForAudio = false;
                        SelectorAudioEvent selectorAudioEvent = new SelectorAudioEvent(isShowTitleForAudio);
                        EventBus.getDefault().post(selectorAudioEvent);
                        KLog.e("角标为=====" + index + "-----是否展示标题" + isShowTitleForAudio);
                    }
                }
            });
