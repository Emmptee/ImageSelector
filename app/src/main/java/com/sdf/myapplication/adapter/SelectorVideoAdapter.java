...
public class SelectorVideoAdapter extends
        RecyclerView.Adapter<SelectorVideoAdapter.ViewHolder> {
    ...
    private boolean isShowTitleForVideo = true;
    /**
     * 点击添加图片跳转
     */
    ...
    public SelectorVideoAdapter(Context context, onAddClickListener mOnAddClickListener) {
...
//            viewHolder.mImg.setVisibility(View.GONE);
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index== 0){
                        isShowTitleForVideo = false;
                        SelectorVideoEvent selectorVideoEvent = new SelectorVideoEvent(isShowTitleForVideo);
                        EventBus.getDefault().post(selectorVideoEvent);
                        KLog.e("角标为=====" + index + "-----是否展示标题" + isShowTitleForVideo);
                    }
                }
            });
